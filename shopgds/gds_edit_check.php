...
<?php
	...
	else
	{
		...
		print '<form method = "post" action = "gds_edit_done.php">';
		print '<input type = "hidden" name = "code" value = "'.$gds_code.'">';
		print '<input type = "hidden" name = "name" value = "'.$gds_name.'">';
		print '<input type = "hidden" name = "price" value = "'.$gds_price.'">';
		print '<input type = "hidden" name = "gazou_name_old" value = "'.$gds_img_name_old.'">';
